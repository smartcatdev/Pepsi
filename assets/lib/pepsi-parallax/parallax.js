jQuery(document).ready( function( $ ) {
    ...
    /**
     * Custom Parallax Library for Pepsi
     * 
     * Proper Parallax
     */
    ...
    function parallaxImages() {
        ...
        var plx = document.getElementsByClassName('pepsi_parallax');
        ...
        for(i=0;i<plx.length;i++){
            ...
            if (scrolled + win_height_padded >= offsetTop) {
                ...
                if (plxImg) {
                    ...
                    plxImg.style.top = (singleScroll / pepsi_local_parallax.intensity_value) + "px";
                }
            }
        }
    }
