jQuery(document).ready(function ($) {
    ...
    $("header#masthead #slim-header-wrap").sticky({
        ...
        $('div#content,div#pepsi-custom-header,div#cart-panel-trigger').addClass('sticky-header');
        ...
        $('div#content,div#pepsi-custom-header,div#cart-panel-trigger').removeClass('sticky-header');
    ...
    if ( $('div#pepsi-custom-header.parallax_layers').length ) {
        ...
        $(window).resize( function(){
            $( '.jparallax-layer' ).parallax({
                ...
                // Image Layer
                xparallax: pepsi_local.parallax_image_layer,
                yparallax: pepsi_local.parallax_image_layer
            },
            {
                // Texture Layer Options
                xparallax: pepsi_local.parallax_texture_layer,
                yparallax: pepsi_local.parallax_texture_layer
            },{
                // Color Layer Options
                xparallax: pepsi_local.parallax_color_layer,
                yparallax: pepsi_local.parallax_color_layer,
                xorigin: 0,
                yorigin: 0,
            },{
                // Content Layer Options
                xparallax: pepsi_local.parallax_content_layer,
                yparallax: pepsi_local.parallax_content_layer
            });
        });
