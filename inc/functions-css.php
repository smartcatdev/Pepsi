...
function pepsi_wp_head_styles() { ?>
    ...
    <style type="text/css">
        ...
        div#pepsi-custom-header.parallax_layers .custom-header-title,
        h2.widget-title,
        ul.product_list_widget .product-wrap .product-title .price-wrap,
        #pepsi-featured-woocommerce h4.product_category_title,
        div#pepsi-woocommerce-wrap ul.products li.product .product_category_title,
        div#pepsi-woocommerce-wrap ul.products li.product .woocommerce-loop-category__title mark {
        ...
        form.edd_form .edd-submit {
            font-family: <?php echo esc_attr( get_theme_mod( PEPSI_OPTIONS::FONT_PRIMARY, PEPSI_DEFAULTS::FONT_PRIMARY ) ); ?>;
        }

        h1,h2,h3,h4,h5,h6 {
            letter-spacing: <?php echo esc_attr( get_theme_mod( PEPSI_OPTIONS::FONT_HEADINGS_LETTER_GAP, PEPSI_DEFAULTS::FONT_HEADINGS_LETTER_GAP ) ); ?>em;
        }

        body {
            font-size: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::FONT_BODY_SIZE, PEPSI_DEFAULTS::FONT_BODY_SIZE ) ); ?>px;
        }
        ...
        <?php if ( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_MENU_FONT_FAMILY, PEPSI_DEFAULTS::CUSTOM_HEADER_MENU_FONT_FAMILY ) == 'secondary' ) : ?>
        ...
        <?php if ( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_TITLE_FONT_FAMILY, PEPSI_DEFAULTS::CUSTOM_HEADER_TITLE_FONT_FAMILY ) == 'primary' ) : ?>
        ...
        <?php if ( get_theme_mod( PEPSI_OPTIONS::WIDGETS_TITLE_FONT_FAMILY, PEPSI_DEFAULTS::WIDGETS_TITLE_FONT_FAMILY ) == 'primary' ) : ?>
        ...
        header#masthead .site-title {
           text-transform: <?php echo get_theme_mod( PEPSI_OPTIONS::NAVBAR_SITE_TITLE_ALL_CAPS, PEPSI_DEFAULTS::NAVBAR_SITE_TITLE_ALL_CAPS ) ? 'uppercase' : 'none'; ?>;
        }
        div#custom-header-content .custom-header-title, 
        div#pepsi-custom-header.parallax_layers .custom-header-title {
           text-transform: <?php echo get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_TITLE_ALL_CAPS, PEPSI_DEFAULTS::CUSTOM_HEADER_TITLE_ALL_CAPS ) ? 'uppercase' : 'none'; ?>;
        }
        footer div#footer-branding-wrap .site-title {
           text-transform: <?php echo get_theme_mod( PEPSI_OPTIONS::FOOTER_SITE_TITLE_ALL_CAPS, PEPSI_DEFAULTS::FOOTER_SITE_TITLE_ALL_CAPS ) ? 'uppercase' : 'none'; ?>;
        }
        h2.widget-title {
            text-transform: <?php echo get_theme_mod( PEPSI_OPTIONS::WIDGETS_TITLE_ALL_CAPS, PEPSI_DEFAULTS::WIDGETS_TITLE_ALL_CAPS ) ? 'uppercase' : 'none'; ?>;
        }
        ...
        <?php $theme_colors = pepsi_get_all_theme_colors(); ?>
        ...
        div#pepsi-woocommerce-wrap span.onsale,
        button, 
        input[type="submit"],
        a.button,
        ...
        .pepsi-pagination-links .page-numbers:hover,
        nav.navigation.post-navigation .nav-links a:hover,
        #wpadminbar .pepsi-toolbar-link a.ab-item,
        #wpadminbar .pepsi-toolbar-link a.ab-item:hover,
        .edd-table td.edd_purchase_details a,
        ...
        <?php if( 
                get_theme_mod( PEPSI_OPTIONS::NAVBAR_FINAL_LINK_FILL, PEPSI_DEFAULTS::NAVBAR_FINAL_LINK_FILL ) 
                && get_theme_mod( PEPSI_OPTIONS::NAVBAR_FINAL_LINK_ACCENT, PEPSI_DEFAULTS::NAVBAR_FINAL_LINK_ACCENT ) 
                ) : ?>
        ...
        div#pepsi-edd-header .price.on-sale {
            color: <?php echo esc_attr( $theme_colors['primary'] ); ?>;
        }

        footer #pepsi_designer path {
        ...
        <?php if ( get_theme_mod( PEPSI_OPTIONS::NAVBAR_BG_STYLE, PEPSI_DEFAULTS::NAVBAR_BG_STYLE ) == 'color' ) : ?>
        ...
        <?php else : ?>
            ...
            div#slim-header-wrap,
            div#banner-header-wrap {
                background-image: url(<?php echo esc_url( get_theme_mod( PEPSI_OPTIONS::NAVBAR_BG_IMAGE, PEPSI_DEFAULTS::NAVBAR_BG_IMAGE ) ); ?>);
            }
        ...
        ul.slim-header-menu > li.menu-item-has-children > ul.sub-menu > li > ul.sub-menu > li > ul.sub-menu > li > a {
            color: <?php echo esc_attr( pepsi_hex2rgba( $theme_colors['navbar_fg'], .6 ) ); ?> !important;
        }
        ...
        ul.slim-header-menu > li.menu-item-has-children > ul.sub-menu > li > ul.sub-menu > li > ul.sub-menu > li > a:hover {
            color: <?php echo esc_attr( pepsi_hex2rgba( $theme_colors['primary'], 1 ) ); ?> !important;
        }
        ...
        div#pre-footer-wrap {
            border-top: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::FOOTER_BORDER_TOP_THICKNESS, PEPSI_DEFAULTS::FOOTER_BORDER_TOP_THICKNESS ) ) ?>px solid <?php echo esc_attr( $theme_colors['primary'] ); ?>;
        ...
        <?php if ( get_theme_mod( PEPSI_OPTIONS::NAVBAR_STYLE, PEPSI_DEFAULTS::NAVBAR_STYLE ) == 'slim_split' || get_theme_mod( PEPSI_OPTIONS::NAVBAR_STYLE, PEPSI_DEFAULTS::NAVBAR_STYLE ) == 'slim_left' ) : ?>
            
            @media (min-width: 992px) {
                div#content {
                    padding-top: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_INITIAL_HEIGHT, PEPSI_DEFAULTS::NAVBAR_INITIAL_HEIGHT ) - 1 ); ?>px;
                }
        ...
        <?php if ( get_theme_mod( PEPSI_OPTIONS::NAVBAR_FINAL_LINK_ACCENT, PEPSI_DEFAULTS::NAVBAR_FINAL_LINK_ACCENT ) ) : ?>
        ...
        <?php if( get_theme_mod( PEPSI_OPTIONS::NAVBAR_FINAL_LINK_ROUNDED, PEPSI_DEFAULTS::NAVBAR_FINAL_LINK_ROUNDED ) ) : ?>
        ...
        <?php if ( get_theme_mod( PEPSI_OPTIONS::NAVBAR_ALWAYS_SHOW_LOGO, PEPSI_DEFAULTS::NAVBAR_ALWAYS_SHOW_LOGO ) || get_theme_mod( PEPSI_OPTIONS::NAVBAR_STYLE, PEPSI_DEFAULTS::NAVBAR_STYLE ) == 'banner' ) : ?>
            header img.custom-logo {
                height: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_INITIAL_HEIGHT, PEPSI_DEFAULTS::NAVBAR_INITIAL_HEIGHT ) ); ?>px;
                margin: 0 <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_LOGO_HORIZONTAL_PADDING, PEPSI_DEFAULTS::NAVBAR_LOGO_HORIZONTAL_PADDING ) ); ?>px;
                opacity: 1;
            }
        <?php else : ?>
            header img.custom-logo {
        ...
        .is-sticky img.custom-logo {
            height: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_STICKY_HEIGHT, PEPSI_DEFAULTS::NAVBAR_STICKY_HEIGHT ) ); ?>px;
            margin: 0 <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_LOGO_HORIZONTAL_PADDING, PEPSI_DEFAULTS::NAVBAR_LOGO_HORIZONTAL_PADDING ) ); ?>px;
        }

        /* ----- Dual Navbar: Toolbar Height Offset ------------------------- */
...
/*        div#dual-header-toolbar {
        ...
        @media (min-width:992px) {
            div#slim-header .right-half {
                min-height: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_INITIAL_HEIGHT, PEPSI_DEFAULTS::NAVBAR_INITIAL_HEIGHT ) - 1 ); ?>px;
            }
        }
        
        #slim-header-wrap ul.slim-header-menu > li > a,
        #slim-header-wrap ul.slim-header-menu > li {
            line-height: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_INITIAL_HEIGHT, PEPSI_DEFAULTS::NAVBAR_INITIAL_HEIGHT ) ); ?>px;
        }
        ...
        @media (min-width:992px) {
            .is-sticky div#slim-header .right-half {
                min-height: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_STICKY_HEIGHT, PEPSI_DEFAULTS::NAVBAR_STICKY_HEIGHT ) - 1 ); ?>px;
            }
        }
        
        .is-sticky #slim-header-wrap ul.slim-header-menu > li > a,
        .is-sticky #slim-header-wrap ul.slim-header-menu > li {
            line-height: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_STICKY_HEIGHT, PEPSI_DEFAULTS::NAVBAR_STICKY_HEIGHT ) ); ?>px;
        }

        /* ----- Slim Navbars: Site Title ----------------------------------- */

        .site-branding .site-title {
            font-size: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_SITE_TITLE_FONT_SIZE, PEPSI_DEFAULTS::NAVBAR_SITE_TITLE_FONT_SIZE ) ); ?>px;
            letter-spacing: <?php echo esc_attr( get_theme_mod( PEPSI_OPTIONS::NAVBAR_SITE_TITLE_LETTER_GAP, PEPSI_DEFAULTS::NAVBAR_SITE_TITLE_LETTER_GAP ) ); ?>em;
        }

        <?php if ( get_theme_mod( PEPSI_OPTIONS::NAVBAR_SITE_TITLE_FONT_FAMILY, PEPSI_DEFAULTS::NAVBAR_SITE_TITLE_FONT_FAMILY ) == 'primary' ) : ?>
        ...
        .site-branding .site-tagline {
            font-size: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_TAGLINE_FONT_SIZE, PEPSI_DEFAULTS::NAVBAR_TAGLINE_FONT_SIZE ) ); ?>px;
        }

        <?php if ( get_theme_mod( PEPSI_OPTIONS::NAVBAR_TAGLINE_FONT_FAMILY, PEPSI_DEFAULTS::NAVBAR_TAGLINE_FONT_FAMILY ) == 'primary' ) : ?>
        ...
        <?php if ( get_theme_mod( PEPSI_OPTIONS::NAVBAR_HIDE_TAGLINE, PEPSI_DEFAULTS::NAVBAR_HIDE_TAGLINE ) ) : ?>
        ...
        ul.slim-header-menu > li {
            padding: 0 <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_LINKS_GAP, PEPSI_DEFAULTS::NAVBAR_LINKS_GAP ) / 2 ); ?>px;
        }

        ul#mobile-menu li a,
        ul.slim-header-menu > li a {
            font-size: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_LINKS_FONT_SIZE, PEPSI_DEFAULTS::NAVBAR_LINKS_FONT_SIZE ) ); ?>px;
        }
        ...
        <?php if ( get_theme_mod( PEPSI_OPTIONS::NAVBAR_MENU_ALIGNMENT, PEPSI_DEFAULTS::NAVBAR_MENU_ALIGNMENT ) == 'right' || get_theme_mod( PEPSI_OPTIONS::NAVBAR_MENU_ALIGNMENT, PEPSI_DEFAULTS::NAVBAR_MENU_ALIGNMENT ) == 'center' ) : ?>
        ...
        <?php if ( ! get_theme_mod( PEPSI_OPTIONS::HOMEPAGE_SHOW_CONTENT, PEPSI_DEFAULTS::HOMEPAGE_SHOW_CONTENT ) ) : ?>
            #front-page-content {
                display: none;
            }
        <?php endif; ?>
        ...
        switch ( get_theme_mod( PEPSI_OPTIONS::BLOG_LAYOUT_NUM_COLS, PEPSI_DEFAULTS::BLOG_LAYOUT_NUM_COLS ) ) :
        ...
        <?php $card_radius = get_theme_mod( PEPSI_OPTIONS::BLOG_CARD_BORDER_RADIUS, PEPSI_DEFAULTS::BLOG_CARD_BORDER_RADIUS ); ?>
        
        .mosaic-grid-blog .mosaic-grid > .blog_item_wrap {
            padding: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::BLOG_CARD_MOSAIC_GAP, PEPSI_DEFAULTS::BLOG_CARD_MOSAIC_GAP ) ); ?>px;
        }
        ...
        <?php if ( ! get_theme_mod( PEPSI_OPTIONS::BLOG_SHOW_CATEGORY, PEPSI_DEFAULTS::BLOG_SHOW_CATEGORY ) ) : ?>
        ...
        <?php if ( ! get_theme_mod( PEPSI_OPTIONS::BLOG_SHOW_COMMENT_COUNT, PEPSI_DEFAULTS::BLOG_SHOW_COMMENT_COUNT ) && ! get_theme_mod( 'blog_layout_show_view_count', false ) ) : ?>
        ...
        .blog_item_wrap .blog_item .entry-title {
            font-size: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::BLOG_CARD_FONT_SIZE_DSK, PEPSI_DEFAULTS::BLOG_CARD_FONT_SIZE_DSK ) ); ?>px;
        }

        .blog_item_wrap .blog_item .inner .blog-meta,
        .standard-stacked-blog .blog_item_wrap .blog_item .blog-meta .posted-meta,
        .standard-stacked-blog .blog-meta div.category-meta .categories-bar {
            font-size: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::BLOG_META_FONT_SIZE, PEPSI_DEFAULTS::BLOG_META_FONT_SIZE ) ); ?>px;
        }

        @media (max-width: 767px) {
            .blog_item_wrap .blog_item .entry-title {
                font-size: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::BLOG_CARD_FONT_SIZE_MBL, PEPSI_DEFAULTS::BLOG_CARD_FONT_SIZE_MBL ) ); ?>px;
            }
        }
        
        /* ----- Standard Blog Cards: Flat or Raised ------------------------ */
        
        <?php if ( get_theme_mod( PEPSI_OPTIONS::BLOG_CARD_APPEARANCE, PEPSI_DEFAULTS::BLOG_CARD_APPEARANCE ) == 'raised' ) : ?>
        ...
        div#custom-header-content .custom-header-title,
        div#pepsi-custom-header.parallax_layers .custom-header-title {
            font-size: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_TITLE_FONT_SIZE, PEPSI_DEFAULTS::CUSTOM_HEADER_TITLE_FONT_SIZE ) ); ?>px;
            letter-spacing: <?php echo esc_attr( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_TITLE_LETTER_GAP, PEPSI_DEFAULTS::CUSTOM_HEADER_TITLE_LETTER_GAP ) ); ?>em;
        }

        ul#custom-header-menu > li a {
            font-size: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_MENU_FONT_SIZE, PEPSI_DEFAULTS::CUSTOM_HEADER_MENU_FONT_SIZE ) ); ?>px;
            letter-spacing: <?php echo esc_attr( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_MENU_LETTER_GAP, PEPSI_DEFAULTS::CUSTOM_HEADER_MENU_LETTER_GAP ) ); ?>em;
            margin: 2px <?php echo intval( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_MENU_LINKS_GAP, PEPSI_DEFAULTS::CUSTOM_HEADER_MENU_LINKS_GAP ) / 2 ); ?>px;
        }

        div#pepsi-custom-header.pepsi_parallax,
        div#pepsi-custom-header.pepsi_parallax .util-tbl-wrap,
        div#pepsi-custom-header.parallax_layers {
            height: <?php echo get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_CALC, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_CALC ) == 'percent' ? intval( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_PCT, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_PCT ) ) . 'vh' : intval( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_PX, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_PX ) ) . 'px'; ?>;
        }

        <?php if ( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_MENU_BUTTONS, PEPSI_DEFAULTS::CUSTOM_HEADER_MENU_BUTTONS ) ) : ?>
        ...
        div#pepsi-custom-header.parallax_layers .jparallax-layer.texture-layer,
        div#pepsi-custom-header.parallax_layers .jparallax-layer.color-layer,
        div#pepsi-custom-header.parallax_layers .jparallax-layer.image-layer {
            width: 115vw;
            height: <?php echo get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_CALC, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_CALC ) == 'percent' ? intval( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_PCT, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_PCT ) + 15 ) . 'vh' : intval( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_PX, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_PX ) * 1.15 ) . 'px'; ?>;
            background-size: cover;
            background-position: 50%;
        }

        div#pepsi-custom-header.parallax_layers .jparallax-layer.texture-layer {
            opacity: <?php echo esc_attr( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_TEXTURE_OPAC, PEPSI_DEFAULTS::CUSTOM_HEADER_TEXTURE_OPAC ) ); ?>;
        }

        div#pepsi-custom-header.parallax_layers .jparallax-layer.color-layer {
            opacity: <?php echo esc_attr( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_COLOR_LAYER_OPACITY, PEPSI_DEFAULTS::CUSTOM_HEADER_COLOR_LAYER_OPACITY ) ); ?>;
        }

        div#pepsi-custom-header.pepsi_parallax div#custom-header-overlay.single,
        div#pepsi-custom-header.parallax_layers .jparallax-layer.color-layer.single {
            background: <?php echo esc_attr( pepsi_hex2rgba( $theme_colors['plx_overlay_single'], get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_COLOR_LAYER_OPACITY, PEPSI_DEFAULTS::CUSTOM_HEADER_COLOR_LAYER_OPACITY ) ) ); ?>;
        }

        div#pepsi-custom-header.pepsi_parallax img.custom-logo,
        div#pepsi-custom-header.parallax_layers .jparallax-layer.content-layer img.custom-logo {
            height: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_LOGO_HEIGHT, PEPSI_DEFAULTS::CUSTOM_HEADER_LOGO_HEIGHT ) ); ?>px;
        }
        ...
        @media (max-width: 991px) {
            ...
            div#pepsi-custom-header.pepsi_parallax .util-tbl-wrap,
            div#pepsi-custom-header.parallax_layers {
                height: <?php echo get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_CALC, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_CALC ) == 'percent' ? intval( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_PCT_MBL, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_PCT_MBL ) ) . 'vh' : intval( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_PX_MBL, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_PX_MBL ) ) . 'px'; ?>;
            }

            div#pepsi-custom-header.parallax_layers .jparallax-layer.texture-layer,
            div#pepsi-custom-header.parallax_layers .jparallax-layer.color-layer,
            div#pepsi-custom-header.parallax_layers .jparallax-layer.image-layer {
                height: <?php echo get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_CALC, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_CALC ) == 'percent' ? intval( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_PCT_MBL, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_PCT_MBL ) + 15 ) . 'vh' : intval( ( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_PX_MBL, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_PX_MBL ) * 1.15 ) ) . 'px'; ?>;
            }

            div#pepsi-custom-header.pepsi_parallax img.custom-logo,
            div#pepsi-custom-header.parallax_layers .jparallax-layer.content-layer img.custom-logo {
                height: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_LOGO_HEIGHT_MBL, PEPSI_DEFAULTS::CUSTOM_HEADER_LOGO_HEIGHT_MBL ) ); ?>px;
            }
        ...
        <?php if ( ( get_theme_mod( PEPSI_OPTIONS::NAVBAR_STYLE, PEPSI_DEFAULTS::NAVBAR_STYLE ) != 'banner' && get_theme_mod( PEPSI_OPTIONS::NAVBAR_STYLE, PEPSI_DEFAULTS::NAVBAR_STYLE ) != 'dual' ) && get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_CALC, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_CALC ) == 'percent' && get_theme_mod( PEPSI_OPTIONS::CUSTOM_HEADER_HEIGHT_PCT, PEPSI_DEFAULTS::CUSTOM_HEADER_HEIGHT_PCT ) == 100 && get_theme_mod( 'custom_header_style_toggle', 'parallax_vertical' ) == 'parallax_vertical' ) : ?>
            ...
            div#pepsi-custom-header.pepsi_parallax,
            div#pepsi-custom-header.pepsi_parallax .util-tbl-wrap {
                height: calc(100vh - <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_INITIAL_HEIGHT, PEPSI_DEFAULTS::NAVBAR_INITIAL_HEIGHT ) - 1 ); ?>px);
            }
            
            body.admin-bar div#pepsi-custom-header.pepsi_parallax,
            body.admin-bar div#pepsi-custom-header.pepsi_parallax .util-tbl-wrap {
                height: calc(100vh - <?php echo intval( get_theme_mod( PEPSI_OPTIONS::NAVBAR_INITIAL_HEIGHT, PEPSI_DEFAULTS::NAVBAR_INITIAL_HEIGHT ) - 1 + 32 ); ?>px);
            }
        ...
        <?php
        switch ( get_theme_mod( PEPSI_OPTIONS::GRADIENT_LINEAR_DIRECTION, PEPSI_DEFAULTS::GRADIENT_LINEAR_DIRECTION ) ) :
        ...
        div#pepsi-custom-header.pepsi_parallax div#custom-header-overlay.gradient,
        div#pepsi-custom-header.parallax_layers .jparallax-layer.color-layer.gradient {
            <?php if ( get_theme_mod( PEPSI_OPTIONS::GRADIENT_STYLE, PEPSI_DEFAULTS::GRADIENT_STYLE ) == 'linear' ) : ?>

                background: -moz-linear-gradient(<?php echo esc_attr( $linear_degrees ); ?>,
                    <?php echo esc_attr( pepsi_hex2rgba( $theme_colors['plx_overlay_grad_start'], get_theme_mod( PEPSI_OPTIONS::GRADIENT_START_COLOR_OPACITY, PEPSI_DEFAULTS::GRADIENT_START_COLOR_OPACITY ) ) ); ?> 0%,
                    <?php echo esc_attr( pepsi_hex2rgba( $theme_colors['plx_overlay_grad_end'], get_theme_mod( PEPSI_OPTIONS::GRADIENT_END_COLOR_OPACITY, PEPSI_DEFAULTS::GRADIENT_END_COLOR_OPACITY ) ) ); ?> 100%);
        ...
        h2.widget-title {
            font-size: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::WIDGETS_TITLE_FONT_SIZE, PEPSI_DEFAULTS::WIDGETS_TITLE_FONT_SIZE ) ); ?>px;
            letter-spacing: <?php echo esc_attr( get_theme_mod( PEPSI_OPTIONS::WIDGETS_TITLE_FONT_LETTER_GAP, PEPSI_DEFAULTS::WIDGETS_TITLE_FONT_LETTER_GAP ) ); ?>em;
        }
        
        footer div#footer-branding-wrap img.custom-logo {
            height: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::FOOTER_ALTERNATE_LOGO_HEIGHT, PEPSI_DEFAULTS::FOOTER_ALTERNATE_LOGO_HEIGHT ) ); ?>px;
        }
        
        div#footer-branding-wrap .site-title {
            font-size: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::FOOTER_SITE_TITLE_FONT_SIZE, PEPSI_DEFAULTS::FOOTER_SITE_TITLE_FONT_SIZE ) ); ?>px;
            letter-spacing: <?php echo esc_attr( get_theme_mod( PEPSI_OPTIONS::NAVBAR_SITE_TITLE_LETTER_GAP, PEPSI_DEFAULTS::NAVBAR_SITE_TITLE_LETTER_GAP ) ); ?>em;
        }

        footer div#footer-branding-wrap {
            font-size: <?php echo intval( get_theme_mod( PEPSI_OPTIONS::FOOTER_COPYRIGHT_TAGLINE_FONT_SIZE, PEPSI_DEFAULTS::FOOTER_COPYRIGHT_TAGLINE_FONT_SIZE ) ); ?>px;
        }

        <?php if ( ! get_theme_mod( PEPSI_OPTIONS::FOOTER_SHOW_BRANDING, PEPSI_DEFAULTS::FOOTER_SHOW_BRANDING ) && ! get_theme_mod( PEPSI_OPTIONS::FOOTER_SHOW_COPYRIGHT, PEPSI_DEFAULTS::FOOTER_SHOW_COPYRIGHT ) ) : ?>
            footer span.pepsi_by {
                padding-left: 0;
                border-left: none;
            }
        <?php endif; ?>
...
add_action( 'wp_head', 'pepsi_wp_head_styles' );
